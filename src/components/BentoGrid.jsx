    ...
    <div className="flex flex-col gap-6 px-6 py-12 max-w-7xl mt-16 mx-auto lg:px-8 lg:mt-32">
      ...
      >
        {gridItems.map((item, index) => (
          <div
            key={index}
            className={`row-start-${item.rowStart} row-end-${item.rowEnd} group rounded-2xl p-[1px] bg-slate-100 hover:bg-gradient-to-br hover:from-red-200 hover:via-purple-200 hover:to-yellow-200`}
          >
